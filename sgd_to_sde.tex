...
After a deep research with chatGPT \href{https://chatgpt.com/s/dr_6853372e8bf48191913b0ad54514ca1b}{here} here is my updated ranking:
\begin{itemize}
    \item Application of CLT from assuming gaussian gradient noise (finite variance in particular, likely that noise is not gaussian but Levy)
...
\begin{itemize}
    ...
    \item Clarify the importance of assuming finite learning rate. 
